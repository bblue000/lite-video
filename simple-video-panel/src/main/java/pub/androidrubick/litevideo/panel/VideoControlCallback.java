...
public interface VideoControlCallback {
     ...
     */
    void onStateChanged(VideoView video, int state, VideoStatus status);
     ...
     * @param total 总资源大小
     */
    void onLoadProgress(VideoView video, String url, long current, long total);
